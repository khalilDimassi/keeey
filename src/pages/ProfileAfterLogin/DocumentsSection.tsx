...
const DocumentsSection: React.FC = () => {
    ...
    return (
        <div className="p-4 bg-white shadow-md rounded-lg " style={{ boxShadow: "10px 4px 15px rgba(0, 128, 0, 0.2)",marginLeft:"4%",marginRight:"4%"}}>
      ...
      />
          <div className="flex space-x-4">
            {documents.map((doc) => (
              <div key={doc.id} className="flex flex-col items-center justify-center shadow-sm border rounded-lg p-4"style={{width:"15rem",height:"13rem"}}>
