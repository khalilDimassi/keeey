...
interface DocumentUploadModalProps {
  ...
  const DocumentUploadModal: React.FC<DocumentUploadModalProps> = ({ isOpen, onClose }) => {
    ...
    backgroundColor: "#215A96",
                ...
                type="submit"
                className=" hover:bg-teal-700 text-white px-4 py-2 rounded-md flex items-center space-x-2"
              >
                <FaPlus size={16} />
                <span>Ajouter</span>
              </button>
...
const DocumentsSectionMissionKplayer: React.FC = () => {
...
export default DocumentsSectionMissionKplayer;