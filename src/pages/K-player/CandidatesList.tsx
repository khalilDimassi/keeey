        ...
        {candidates.map((candidate) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="bg-blue-800 text-white px-4 py-2 rounded-3xl flex items-center gap-2">
                Valider l’intérêt
              </button>
              <div className="bg-blue-800 p-2 rounded-full flex items-center justify-center">
