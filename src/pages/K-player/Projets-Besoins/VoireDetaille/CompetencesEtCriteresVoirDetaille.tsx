      ...
      <div className=" bg-white  rounded-lg ">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="border p-2 rounded-xl text-gray-700">✔ Automobile / Equipementiers</div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input type="text" className="w-full border rounded-xl p-2" placeholder="Outils / habilitations" />
            </div>
            <div className="space-y-2">
              <h3 className="text-sm text-gray-600">Qualité Relationnelles</h3>
              <input type="text" className="w-full border rounded-xl p-2" placeholder="Qualité Relationnelles" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input type="text" className="border rounded-xl p-2 w-24" placeholder="Langue" />
              <input type="text" className="border rounded-xl p-2 w-24" placeholder="Langue" />
            </div>
          </div>
        </div>
