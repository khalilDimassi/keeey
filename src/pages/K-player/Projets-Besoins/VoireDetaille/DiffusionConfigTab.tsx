  ...
  return (
    <div className="max-w-7xl mx-auto bg-white ">
      <div className="flex flex-col md:flex-row gap-4">
        {/* Colonne de gauche - avec largeur augmentée */}
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between cursor-pointer">
                ...
                <div
                  className={`relative w-12 h-6 flex items-center rounded-full p-1 cursor-pointer transition-all ${
                    selectedOption === 'non-visible' ? "bg-blue-800" : "bg-gray-300"
                  }`}
                  onClick={() => handleOptionChange('non-visible')}
                >
                  <div
                    className={`w-5 h-5 bg-white rounded-full shadow-md transform transition-transform ${
                      selectedOption === 'non-visible' ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between cursor-pointer">
                ...
                <div
                  className={`relative w-12 h-6 flex items-center rounded-full p-1 cursor-pointer transition-all ${
                    selectedOption === 'totalement-visible' ? "bg-blue-800" : "bg-gray-300"
                  }`}
                  onClick={() => handleOptionChange('totalement-visible')}
                >
                  <div
                    className={`w-5 h-5 bg-white rounded-full shadow-md transform transition-transform ${
                      selectedOption === 'totalement-visible' ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between cursor-pointer">
                ...
                <div
                  className={`relative w-12 h-6 flex items-center rounded-full p-1 cursor-pointer transition-all ${
                    selectedOption === 'contacts-selectionnes' ? "bg-blue-800" : "bg-gray-300"
                  }`}
                  onClick={() => handleOptionChange('contacts-selectionnes')}
                >
                  <div
                    className={`w-5 h-5 bg-white rounded-full shadow-md transform transition-transform ${
                      selectedOption === 'contacts-selectionnes' ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></div>
                </div>
              </div>
