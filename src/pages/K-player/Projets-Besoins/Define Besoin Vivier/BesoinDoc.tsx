...
const BesoinDocModal: React.FC<BesoinDocModalProps> = ({ isOpen, onClose }) => {
...
const BesoinDoc: React.FC = () => {
    const [isModalOpen, setIsModalOpen] = useState(false);

    // Uncomment this to show the documents (static examples)
    // const documents = [
    //     { id: 1, name: "K-BIS" },
    //     { id: 2, name: "RIB" },
    // ];
        ...
        <div className="p-4 bg-white shadow-md rounded-lg" style={{ boxShadow: "0 0 4px 1px rgba(17, 53, 93, 0.41)", borderRadius: "10px" }}>
            <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-blue-700" onClick={() => setIsModalOpen(true)}>
                    <FaPlus size={20} className="text-blue-700" />
                </button>
            </div>
            ...
            <div className="flex space-x-4 text-sm italic">
                {/* Uncomment this to show the documents
                {documents.map((doc) => (
                <div key={doc.id} className="flex flex-col items-center justify-center shadow-sm border rounded-lg p-4" style={{ width: "10rem", height: "9rem" }}>
