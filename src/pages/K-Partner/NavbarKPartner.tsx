...
const NavbarKPartner = () => {
  ...
  return (
    <div className="flex justify-between items-center bg-white p-2 rounded-xl" style={{ boxShadow: "0 4px 15px rgba(190, 154, 35, 0.27)" }}>
      ...
      <button
        ...
        className={`${authenticated ? "bg-gray-500 hover:bg-gray-600" : "bg-blue-800 hover:bg-blue-700"
          } text-white px-4 py-2 rounded-xl flex items-center`} style={{ background: " #A58E56" }}
      >
