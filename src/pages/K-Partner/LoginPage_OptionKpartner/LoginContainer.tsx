...
import LoginOptionsKPlayer from "./LoginOptionsPartner";
import LoginPageKPlayer from "./LoginPagePartner";
import LoginPagePartner from "./LoginPagePartner";
import LoginOptionsPartner from "./LoginOptionsPartner";

const LoginContainerKPartner = () => {
    ...
    <div className="px-4">
      <header className="w-full mt-4 h-16 flex items-center relative">
        ...
        >
          <svg width="160" height="61" viewBox="0 0 160 61" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => navigate("/")} >
            <rect y="3" width="42" height="56" fill="#A89B7B" />
      ...
      <main>
        <div className="flex gap-10 px-20 flex-col md:flex-row w-full rounded-lg">
          ...
          <motion.div
            className="w-full  md:w-1/3  relative max-w-sm sm:max-w-md md:max-w-lg py-16 bg-white sm:p-2 shadow-lg rounded-2xl"
            style={{ boxShadow: "0 1px 8px 3px #A89B7B", borderRadius: "16px" }}
          ...
          >
            <div className="max-w-sm mx-auto p-4 text-black">
              <ul className="list-disc pl-10 text-lg font-semibold">
                <li>Cabinet de conseil</li>
                <li>Bureau d'études</li>
                <li>Cabinet de recrutement</li>
              </ul>

              <p className="mt-4">
                Vous êtes à la <span className="text-[#A89B7B] font-semibold">recherche de Talents</span> pour les Projets de vos clients <span className="text-[#A89B7B] font-semibold">OU d'opportunités pour vos consultants</span> ou votre réseau
              </p>
              ...
              <ul className="mt-2 space-y-3">
                <li>
                  <span className="text-[#A89B7B] font-semibold">Identifier rapidement des Profils pertinents</span> pour vos clients
                </li>
                <li>
                  <span className="text-[#A89B7B] font-semibold">Identifier des Opportunités</span> pour vos consultants
                </li>
                <li>
                  Gérer facilement vos <span className="text-[#A89B7B] font-semibold">dossiers de compétences</span>
                </li>
                <li>
                  <span className="text-[#A89B7B] font-semibold">Gérer la diffusion</span> de vos offres de missions
                </li>
                <li>
                  <span className="text-[#A89B7B] font-semibold">Suivre les missions</span> de vos consultants
                </li>
                <li>
                  <span className="text-[#A89B7B] font-semibold">Garder le contact</span> avec vos partenaires et votre réseau
                </li>
                <li>
                  <span className="text-[#A89B7B] font-semibold">Garder le contrôle</span> sur la visibilité de vos profils
                </li>
              </ul>
            </div>
          </motion.div>
...
export default LoginContainerKPartner;