      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50 p-4">
        <div className="bg-white rounded-2xl p-8 max-w-md">
          ...
          <div className="flex justify-center mt-4">
            <button className="px-4 py-2 bg-[#d4e3e6] rounded-md" onClick={onClose}>
              Fermer
            </button>
          </div>
        </div>
    ...
    <div onClick={onClose} className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50 p-4">
      <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-xl w-4/6 shadow-xl relative flex flex-col overflow-y-hidden">
        ...
        {(() => {
          ...
          const hasDescription = opportunity.description && opportunity.description.trim() !== '';
          ...
          const isDetailed = hasContext || hasMissions || hasCandidateProfile;
                ...
                {opportunity.contract_roles &&
                  <div className="flex flex-row items-center gap-3 mb-4">
                    ...
                    {opportunity.contract_roles.map((item, index) => (
                      <div key={index} className="bg-[#d4e3e6] rounded-xl text-sm font-medium px-2 py-1">{item}</div>
                    ))}
                  </div>
                }
                ...
                <div className="bg-white px-4">
                  ...
                  {opportunity.contract_roles &&
                    <div className="flex flex-row items-center gap-3 mb-3">
                      ...
                      {opportunity.contract_roles.map((item, index) => (
                        <div key={index} className="bg-[#d4e3e6] rounded-xl text-xs font-medium px-1 py-0.5">{item}</div>
                      ))}
                    </div>
                  }
                  ...
                  <div className="mb-4 flex flex-col gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      {opportunityCompetences?.sectors?.map((item) => (
                        <div className="bg-[#d4e3e6] rounded-xl text-xs font-medium px-2 py-0.5">{item}</div>
                      ))}
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
