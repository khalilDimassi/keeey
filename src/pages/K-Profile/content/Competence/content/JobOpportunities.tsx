    ...
    <div className="mt-10">
      <div className="relative shadow-sm rounded-lg">
        ...
        <div className="flex items-center justify-between">
            ...
            {(["Opportunités",
              ...
              "Clients étant intéressés"] as OpportunityTab[]).map(tab => (
                <button
                  ...
                  className={`px-8 py-3 flex gap-2 font-medium transition-all relative ${activeTab === tab
          ...
          {/* Threshold Filter */}
          <div className="bg-white px-6 py-4 border-t rounded-t-xl z-10 border-gray-100 flex items-center">
            <label
              htmlFor="matchThreshold"
              className="block text-sm font-medium text-gray-700 mr-3"
            >
              Filtre de compatibilité:
              <span className="font-semibold ml-2 text-teal-600">
                {threshold}%
              </span>
            </label>
            <button
            ...
            <input
              ...
              className="w-full h-2 mx-2 bg-gray-200 rounded-xl appearance-none
          ...
          {/* Contract selector */}
          <select
            className="px-4 py-2 font-medium text-gray-500 border border-gray-200 rounded-xl focus:ring-teal-500 focus:border-teal-500"
            value={contractType}
        ...
        {/* List */}
        <div className="overflow-y-auto bg-white rounded-xl shadow-lg p-6">
          <OpportunityList
            items={filteredItems}
            loading={loading}
            error={error}
